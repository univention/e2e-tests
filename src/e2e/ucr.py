...
class UCR:
    def __init__(self, k8s: KubernetesCluster, release_name: str) -> None:
        ...
        configmap_name = add_release_prefix("stack-data-ums-ucr", release_name)
        self.configmap = k8s.get_configmap(configmap_name)
    ...
    def _save(self):
        self.k8s.update_configmap_data(
            "base.conf", self._vars_to_config_map_str(), add_release_prefix("stack-data-ums-ucr", self.release_name)
        )
