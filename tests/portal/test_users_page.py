...
def test_admin_user_can_view_users_page(
    ...
    # TODO: The user list takes unnaturally long to appear.
    #  We are using a locator timeout to handle that.
    #  Replace this with an increased global timeout as soon
