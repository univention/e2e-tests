...
class TestLeftSidebar:
    def test_left_sidebar_contains_expected_links(self, navigate_to_home_page_logged_in_as_admin):
    ...
    def test_left_sidebar_is_not_accessible_if_no_tiles_exist(
        self, navigate_to_home_page_logged_in_user_without_groups
    ):
