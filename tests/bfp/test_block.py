...
def test_device_block(
    trigger_device_block_chromium_ip_1,
...
def test_api_ip_block(
    ...
    # Allow ~1 second for the handler to retrieve the
    # logins and evaluate actions
    sleep(2)
    r = kc_api.get_oidc_token(username, password)
    # HTTP 429 -
    # Too many failed login attempts on this IP. Wait for cooldown.
